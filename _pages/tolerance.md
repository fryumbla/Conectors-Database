...
In this research, we analyze the mating tolerance of different types of plug-in cable connectors and demonstrate experimentally that the mating process can be achieved by just using position control of conventional industrial robots. 
...
<img src="{{ site.url }}{{ site.baseurl }}/images/tolerance/F1.jpg" width="400" class="center">

## Mating process test
<img src="{{ site.url }}{{ site.baseurl }}/images/tolerance/F2.png" height="200" width="200" class="center">
