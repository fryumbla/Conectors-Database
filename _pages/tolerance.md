...
<img src="{{ site.url }}{{ site.baseurl }}/images/tolerance/F1.jpg" alt="linearly separable data" height="800" width="800" align="middle">

## Mating process test
<img src="{{ site.url }}{{ site.baseurl }}/images/tolerance/F2.png" alt="linearly separable data" height="800" width="800">

<img src="{{ site.url }}{{ site.baseurl }}/images/tolerance/F3.jpg" alt="linearly separable data" height="800" width="800">
<img src="{{ site.url }}{{ site.baseurl }}/images/tolerance/F4.jpg" alt="linearly separable data" height="800" width="800">
...
<img src="{{ site.url }}{{ site.baseurl }}/images/tolerance/F5.jpg" alt="linearly separable data" height="800" width="800">



<style type="text/css">
.tg  {border-collapse:collapse;border-spacing:0;border-color:#aaa;}
.tg td{font-family:Arial, sans-serif;font-size:14px;padding:30px 5px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;border-color:#aaa;color:#333;background-color:#fff;}
.tg th{font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:30px 5px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;border-color:#aaa;color:#fff;background-color:#f38630;}
...
<table class="tg">
  ...
  <tr>
    ...
    <td class="tg-baqh">ELEPARTS</td>
    <td class="tg-baqh">MO0301</td>
    <td class="tg-baqh">1</td>
    <td class="tg-baqh">1.800</td>
  ...
  <tr>
    ...
    <td class="tg-yq6s">C4</td>
    <td class="tg-yq6s">YEONHO</td>
    <td class="tg-yq6s">SMH250-800</td>
    <td class="tg-yq6s">800</td>
