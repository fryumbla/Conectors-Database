...
<img src="{{ site.url }}{{ site.baseurl }}/images/tolerance/F1.jpg" alt="linearly separable data" height="600" width="600" align="middle">

## Mating process test
<img src="{{ site.url }}{{ site.baseurl }}/images/tolerance/F2.png" alt="linearly separable data" height="600" width="600">

<img src="{{ site.url }}{{ site.baseurl }}/images/tolerance/F3.jpg" alt="linearly separable data" height="600" width="600">
<img src="{{ site.url }}{{ site.baseurl }}/images/tolerance/F4.jpg" alt="linearly separable data" height="600" width="600">
...
<img src="{{ site.url }}{{ site.baseurl }}/images/tolerance/F5.jpg" alt="linearly separable data" height="600" width="600">
...
<table class="tg">
  ...
  <tr>
    ...
    <td class="tg-yq6s">C4</td>
    <td class="tg-yq6s">YEONHO</td>
    <td class="tg-yq6s">SMH250-600</td>
    <td class="tg-yq6s">600</td>
